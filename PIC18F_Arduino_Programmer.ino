// Desclaimer: Ididn't Write THis Code
///********************************************************************///
///                    >>  PIC18F2XXX/4XXX Programmer  <<                   ///
///  Program Description: This program turns the Arduino into a programmer
///  for PIC microcontrollers from the 18F series.                         ///
///********************************************************************///
...
///***************************************************///
///          startLowProg الدالة:                   ///
///          الخرج: إدخال المتحكم بيك إلى نمط البرمجة منخفضة الطاقة              ///
///***************************************************///
void startLowProg()
{
...
///***************************************************///
///            endprog()  الدالة:                 ///
///            الخرج: إيقاف برمجة المتحكم وإخراجه من نمط البرمجة             ///                              
///***************************************************///
void endprog()
{
digitalWrite(PGD,LOW);
...
///***************************************************///
///         EraseDevice()  : الدالة                ///
///      الخرج: مسح جميع محتويات ذاكرة و مسجلات المتحكم بيك      ///
///***************************************************///
void EraseDevice()
{
senddata(0,16,ERASE);
...
///***************************************************///
///            program()   الدالة:                ///
///        الخرج: كتابة البيانات على ذاكرة البرمجة     ///
///***************************************************///
void program()
{
...
///**************************************************///
///          idWrite()  : الدالة                  ///
///     الخرج: كتابة البيانات التعريفية على المتحكم بيك 18         ///
///**************************************************///
void idWrite()
{
j=8;
...
///**************************************************///
///        void eepromWrite()  الدالة:           ///
///      الخرج: كتابة البيانات على ذاكرة البيانات          ///
///**************************************************///
void eepromWrite()
{
senddata(0,2,EEPROG);
...
///**************************************************///
///          configWrite()   الدالة:             ///
///     الخرج: صبط قيم فيوزات المتحكم بيك      ///
///**************************************************///
void configWrite()
{
senddata(0,6,CONFIG);
...
///**************************************************///
///            senddata()  الدالة:               ///
///       الخرج: إرسال البيانات للمتحكم بيك           ///
///**************************************************///
