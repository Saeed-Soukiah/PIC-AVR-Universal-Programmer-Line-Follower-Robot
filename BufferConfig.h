// Desclaimer: I didn't Make this code //
///**************************************************///
///   >>  Library for Arduino Code to Function as a Programmer for PIC Microcontrollers  <<  ///
/// Program Description: A programming library that contains all register locations and
/// memory mappings for PIC microcontrollers from the 18F series.                        ///
///**************************************************///
//------------------------------------------------------> مسح محتويات ذاكرة المتحكم <--------------------
...
//---------------------------------------------------> ID مواقع برمجة البيانات التعريفية <------------------
//                                               4-Bit command  |  Data Payload        | Core Instruction 
